...
- 원본 링크: https://github.com/chuspeeism/dashi-taskboard
- 발행: 2026-08-19T03:34:26.738684+00:00
- 접근상태: 확인 완료

---

GitHub - chuspeeism/dashi-taskboard · GitHub 
 ...
 main Branches Tags Go to file Code Open more actions menu Latest commit   History 565 Commits 565 Commits Folders and files Name Name Last commit message Last commit date .codex/ environments .codex/ environments     .github/ workflows .github/ workflows     cli cli     cloud cloud     docs docs     inject inject     scripts scripts     server server     shared shared     skills/ manage-taskboard skills/ manage-taskboard     src-tauri src-tauri     test test     web web     .gitignore .gitignore     AGENTS.md AGENTS.md     LICENSE LICENSE     PRIVACY.md PRIVACY.md     README.md README.md     README.zh-CN.md README.zh-CN.md     package-lock.json package-lock.json     package.json package.json     rust-toolchain.toml rust-toolchain.toml     wrangler.jsonc wrangler.jsonc     View all files Repository files navigation README Apache-2.0 license More items English | 简体中文 
...
npm run app:build:windows 
 ...
 0.0.0.0 
 HTTP bind address; use 127.0.0.1 to disable LAN access 
 ...
 Each device keeps its own project checkout mapping and continues to use a local companion for Codex, Git/worktree, Skill, and MCP capabilities. Cloud mode never falls back to or double-writes the 