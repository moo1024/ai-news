...
GitHub - larashero3-dotcom/lieflat-charts: Data visualization Skill for AI Agents, turning data into polished, interactive HTML charts. 面向 AI Agents 的数据可视化 Skill，将数据快速生成精致、可交互的 HTML 图表。 · GitHub 
 ...
 main Branches Tags Go to file Code Open more actions menu Latest commit   History 41 Commits 41 Commits Folders and files Name Name Last commit message Last commit date agents agents     docs/ assets docs/ assets     examples examples     scripts scripts     templates templates     .gitignore .gitignore     LICENSE LICENSE     README.en.md README.en.md     README.md README.md     SKILL.md SKILL.md     THIRD_PARTY_NOTICES.md THIRD_PARTY_NOTICES.md     catalog.md catalog.md     color-presets.js color-presets.js     mono-tokens.js mono-tokens.js     report-catalog.md report-catalog.md     View all files Repository files navigation README License More items Lieflat Charts 
 中文 | English 
 ...
 理解设计语言 
 需要从 Skill 文件重新建立理解 
 Skill 已在相同的 Agent 工作环境中完成设计和验证 
 
 
 读取规则、模板和数据 
 通常需要反复上传文件或提供路径 
 规则、模板、数据和成品可以保留在同一个工作区 
 
 
 多轮选择和修改图表 
 更换对话后可能需要重新说明背景 
 Agent 可以沿用工作区中的文件和上下文继续修改 
 
 
 生成最终结果 
 结果可能停留在对话或临时目录中 
 HTML 成品可以和数据、模板一起留在工作区继续完善 
...
默认先比较 Lupi Editorial 和 Lupi Basics 候选；两组都不适配时，再使用 Glance。
 ...
 Lupi Editorial 
 15 
 年报、论文、公众号、海报、作品集；读者愿意停下来细看 
 手写 SVG 
 
 
 Lupi Basics 
 13 
 柱、折线、面积、环形、散点、瀑布、热力、进度、矩形树图等基础数据形状 
 手写 SVG / ECharts 
 
 
 Glance 
 18 
 周报、dashboard、监控、汇报；需要快速排序和比较 
 Chart.js / ECharts 
 ...
 Color Presets 
 3 套 / 15 个样张 
 需要颜色区分数据维度，或为 Mono 加一个受控视线落点 
 基于原模板换肤 
 
 
 Report Templates 
 12 套 / 中英双版 
 调研、年报、月报、仪表盘、海报、简报和个人记录等完整整页报告 
 单文件 HTML 
...
└── scripts/validate.mjs # 发布前检查
 ...
 Topics agent-skills charts claude-code codex data-visualization html moxt svg Resources Readme License Activity Stars 2.0k stars Watchers 0 watching Forks 101 forks Report repository Releases Packages Contributors Languages 
