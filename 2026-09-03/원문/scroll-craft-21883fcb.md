...
GitHub - nateherkai/scroll-craft: Claude Code skill for premium scroll-driven websites. Scroll becomes the timeline, on a real design floor, verified by screenshotting its own scroll. · GitHub 
 ...
 main Branches Tags Go to file Code Open more actions menu Latest commit   History 12 Commits 12 Commits Folders and files Name Name Last commit message Last commit date .claude-plugin .claude-plugin     media media     plugins/ nateherk-design plugins/ nateherk-design     .env.example .env.example     .gitignore .gitignore     EXAMPLES.md EXAMPLES.md     LICENSE LICENSE     README.md README.md     View all files Repository files navigation README MIT license More items scroll-craft 
...
└── skills/scroll-craft/
 ...
 About Claude Code skill for premium scroll-driven websites. Scroll becomes the timeline, on a real design floor, verified by screenshotting its own scroll.
 github.com/nateherkai/scroll-craft Topics accessibility agent-skills ai-web-design anthropic claude-code claude-code-plugin creative-coding design-system frontend interaction-design landing-page scroll-animation scrollytelling typography web-design Resources Readme MIT license Activity Stars 1.6k stars Watchers 4 watching Forks 246 forks Report repository Releases Packages Contributors Languages 
