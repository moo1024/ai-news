...
- 출처: Latent Space
- 원본 링크: https://www.latent.space/p/astra
- 발행: 2026-09-03T21:09:41+00:00
- 접근상태: 확인 완료
...
GPT-6 Astra: an automated AI Engineer you can hire for <$6 an hour 
 ...
 our logs Managing fleets of subagents (individually tweaked, bounded concurrency) Now of course, if you just throw on Astra at Ultra you’re gonna burn through a lot more than $6 per hour…. because it is so dang good at parallelizing.
 
 Monitoring its own runs, starting and stopping waves This is basically what i’d pay a junior AI Engineer to do. and I spent about $100 over 2 days to do this.
 Making model benchmarks, handling money, making estimates, scaling up runs, getting human ratings Wild.
 example here We are out of time for this writeup, will complete this later, so if you are reading this on email, check back at the end of the day.
 ...
 1 We are running similar work on Grok, Fable and other similar frontier models but OpenAI was most generous with trial limits so this gets the writeup - but the agentic coding patterns discussed here will likely apply to all such late 2026 frontier models. 
 2 Many of you are waiting to hear results… sorry for the radio silence! we got… busy! We will announce winners and reimbursements and best attempts.
 25 Share Previous Discussion about this post Comments Restacks Top Latest Discussions No posts
