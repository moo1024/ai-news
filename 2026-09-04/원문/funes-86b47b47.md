...
- 원본 링크: https://huggingface.co/blog/funes
- 발행: 2026-09-03T00:00:00+00:00
- 접근상태: 확인 완료
...
and discoverable on the Hub . The Hub
...
run locally, on Lance 's append-only datasets with
...
work is in fitting them into a memory an agent can actually use.
 ...
 funes is open source too. Open an issue 
for anything from an install snag to a recall that missed, or an agent you'd like
supported.

 Datasets mentioned in this article 2 dacorvo/funes-handoff-recall-benchmark Traces • Updated about 13 hours ago • 41 • 448 huggingface/funes-memory Updated 1 day ago • 270 More Articles from our Blog
 announcement open-source community The Open Source Community is backing OpenEnv for Agentic RL +16 114 June 8, 2026 announcement mlx llm The PR you would have opened yourself 73 April 16, 2026 Community Edit Preview Upload images, audio, and videos by dragging in the text input, pasting, or clicking here . Tap or paste here to upload images Comment · Sign up or log in to comment
 Upvote 8 Datasets mentioned in this article 2 dacorvo/funes-handoff-recall-benchmark Traces • Updated about 13 hours ago • 41 • 448 huggingface/funes-memory Updated 1 day ago • 270 System theme Company TOS Privacy About Careers Website Models Datasets Spaces Pricing Docs