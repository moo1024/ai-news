...
- 출처: Hacker News
- 원본 링크: https://manualdousuario.net/en/libreoffice-download-record-no-ai/
- 발행: 2026-09-08T14:05:57+00:00
- 접근상태: 확인 완료
...
LibreOffice breaks download records after declaring it has no AI features ⁄ Manual do Usuário 
 ...
 I don’t really like the “Human-made” badging trend 
 Boox Go 10.3 (gen II) Lumi: An Android tablet that’s also, on top of that, an E-ink screen 
 
 Random Posts 
 
 
 LibreOffice breaks download records after declaring it has no AI features   8/9/2026 
 
 
 About the password leak of 183 million Gmail accounts   29/10/2025 
 
 
 Today I learned that Bluesky’s technical advisor…   23/4/2026 
 
 
 BasicSync and Synctrain: solid apps for bringing Syncthing to phones   5/8/2026 
 
 
 Samsung: Hand over tour health data to train AI, or we’ll delete it all   14/7/2026 
 
 
 End of the line for ad-blocking extensions on Chrome and (most of) its forks   16/6/2026 
