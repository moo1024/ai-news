...
- 출처: Hacker News
- 원본 링크: https://calpaterson.com/memoryfields.html
- 발행: 2026-08-31T11:17:25+00:00
- 접근상태: 확인 완료
...
is large, then you're loading a lot of openapi.json into the context. If
...
For example using perl to do find-and-replaces across the whole corpus, or
...
RAG systems are often about reads, but memoryfields are for writing too.
 ...
 Isn't nomic-embed-text-v1.5 over 2 years old? Aren't there newer and
better models?

 
 Embedding models are neither as large as frontier models, nor as fast moving.
 nomic-embed-text-v1.5 remains a
...
helps agents fact check outdated or otherwise suspect material.
 ...
 What about security? What about "Disregard
that!"? 
...
manually review and pin (via sha256sum ) memoryfields you get from others.
