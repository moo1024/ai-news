...
- 출처: Claude Code 릴리스
- 원본 링크: https://github.com/anthropics/claude-code/releases/tag/v2.1.260
- 발행: 2026-09-03T23:48:12+00:00
- 접근상태: 확인 완료

---

Release v2.1.260 · anthropics/claude-code · GitHub 
 ...
 [VSCode] Fixed a half-finished message, an empty tool card or an extra "Thought for" line staying on screen after Claude Code retried a dropped 