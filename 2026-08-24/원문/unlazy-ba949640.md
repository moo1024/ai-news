...
Codex CLI: ~/.codex/skills/unlazy
 ...
 Full specification: references/gates.md .
...
.unlazy/<scope>/gates/node-*.md
 ...
 Read references/method.md , references/orchestration.md , and references/parallel.md before parallel fan-out.
...
node <path-to-skill>/scripts/install-hooks.mjs --uninstall
 ...
 Contributor history and pull-request links are recorded in CHANGELOG.md .
...
tests/ deterministic behavior and regression tests
 ...
 SlopCodeBench reports that no tested agent fully solved a problem end to end and that the best agent passed 14.8% of checkp