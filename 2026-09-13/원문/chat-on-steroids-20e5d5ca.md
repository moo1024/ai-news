...
GitHub - totec448-spec/chat-on-steroids: Cross-platform local MCP capabilities for ChatGPT with Chrome integration, Goal, Compact & Resume, and durable multi-agent workflows. · GitHub 
 ...
 Topics automation chatgpt chrome-extension electron linux local-first macos mcp multi-agent windows Resources Readme MIT license Contributing Contributing Security policy Security policy Activity Stars 2.0k stars Watchers 6 watching Forks 261 forks Report repository Releases Packages Contributors Languages 
