...
GitHub - AminBlg/SimpleEnglish: Agent skill: make LLMs write docs in ASD-STE100 Simplified Technical · GitHub 
 ...
 main Branches Tags Go to file Code Open more actions menu Latest commit   History 26 Commits 26 Commits Folders and files Name Name Last commit message Last commit date .claude-plugin .claude-plugin     evals evals     examples examples     output-styles output-styles     prompts prompts     skills/ simple-english skills/ simple-english     .gitignore .gitignore     LICENSE LICENSE     README.md README.md     View all files Repository files navigation README MIT license More items 
...
Set DB_PASSWORD to the correct value, then connect again.
 ...
 Resources Readme MIT license Activity Stars 2.6k stars Watchers 6 watching Forks 94 forks Report repository Releases Contributors Languages 
