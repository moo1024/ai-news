...
most recent release and a version tag such as :v0.0.9 pins one.
 ...
 /routines 
 See the routines that are standing, and stop one. 
 ...
 /admin/plugins 
 Configure MCP servers and grant their tools to Bots. 
 
 
 /admin/skills 
 Write deployment skills and grant them to Bots. 
 
 
 /admin/people 
 List, promote, demote, and remove people who have signed in. 
 
 
 /admin/identity-providers 
 Register a company SAML or OIDC provider, routed by email domain. 
