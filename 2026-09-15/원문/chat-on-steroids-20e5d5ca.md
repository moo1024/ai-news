...
GitHub - totec448-spec/chat-on-steroids: Cross-platform local MCP capabilities for ChatGPT with Chrome integration, Goal, Compact & Resume, and durable multi-agent workflows. · GitHub 
 ...
 Uses your ChatGPT conversation rather than invoking Codex directly. 
 ChatGPT Work and Codex share usage limits. Your account’s model availability, usage and context limits still apply. OpenAI usage details → 
 ...
 Topics automation chatgpt chrome-extension electron linux local-first macos mcp multi-agent windows Resources Readme MIT license Contributing Contributing Security policy Security policy Activity Stars 2.6k stars Watchers 8 watching Forks 339 forks Report repository Releases Packages Contributors Languages 
