...
- 원본 링크: https://huggingface.co/blog/multi-vector-encoder
- 발행: 2026-08-18T00:00:00+00:00
- 접근상태: 확인 완료
...
Multi-Vector (Late Interaction) Embedding Models with Sentence Transformers 
 ...
 Published
 August 18, 2026 Update on GitHub Upvote 42 +36 Tom Aarsen tomaarsen Follow Antoine Chaffin NohTow Follow lightonai Raphael Sourty raphaelsty Follow lightonai 
 ...
 MaxSim ( Q , D ) = ∑ Q i ∈ Q max ⁡ D j ∈ D Q i ⋅ D j \text{MaxSim}(Q, D) = \sum_{Q_i \in Q} \max_{D_j \in D} Q_i \cdot D_j MaxSim ( Q , D ) = Q i ​ ∈ Q ∑ ​ D j ​ ∈ D max ​ Q i ​ ⋅ D j ​ 
