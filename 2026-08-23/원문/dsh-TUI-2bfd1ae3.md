...
dsh-tui 
 ...
 Herdr 
 在 Herdr pane 中直接运行 dsh-tui 即可，无需额外配置。
...
macOS 自带 Terminal.app 会自行消费 ⌘ 快捷键，请继续使用 Ctrl 。
 ...
 滚轮 
 仅在 fullscreen 且鼠标跟踪启用时：Help 打开时滚动帮助，否则滚动消息列表（±3 行/格）；默认 inline 模式不会把滚轮事件交给 TUI 
