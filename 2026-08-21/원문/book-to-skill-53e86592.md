...
book - to - skill ui 
 ...
 Topics agent agent-memory agent-skill agent-skills agentic agentic-ai agents ai-agents claude claude-code claude-code-plugin claude-skills github-copilot pdf pdf-document pdf-generation pdf-parser pdf-tools pdf-viewer skill-generator Resources Readme MIT license Contributing Contributing Security policy Security policy Activity Stars 1.2k stars Watchers 500 watching Forks 143 forks Report repository Releases Packages Contributors Languages 
