...
GitHub - s1dashu/ip-as-logo-skill: A compact Agent Skill for highly simplified, rounded, subtly neo-skeuomorphic IP mascot logos. · GitHub 
 ...
 main Branches Tags Go to file Code Open more actions menu Latest commit   History 29 Commits 29 Commits Folders and files Name Name Last commit message Last commit date assets assets     .gitignore .gitignore     LICENSE LICENSE     README.md README.md     SKILL.md SKILL.md     View all files Repository files navigation README MIT license More items IP as Logo 
...
LICENSE
 ...
 ipaslogo.com Topics codex codex-skill image-generation logo-design mascot-design Resources Readme MIT license Activity Stars 3.0k stars Watchers 2 watching Forks 147 forks Report repository Releases Packages Contributors 
